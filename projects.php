...
<body class="page-projects">
    ...
    <div id="wrapper">
        ...
        <div id="content" class="no-top no-bottom">
			...
			<!-- section begin -->
            <section id="cta" class="call-to-action text-light padding30 bg-color" aria-label="cta">
                <div class="container mb10">
                    <div class="row">
                        <div class="col-md-8">
                            <h3 class="mt20">Request Free Consultation and Lets Do It!</h3>
                        </div>

                        <div class="col-md-4 text-right">
                            <a href="contact.html" class="btn btn-line btn-big mt10">Request Now</a>
                        </div>
                    </div>
                </div>
            </section>
        ...
        <footer>
            <div class="container pb40">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        &copy; Copyright 2019 - Archi Garden Website Template by <span class="id-color">Designesia</span>
                    </div>
