...
<body class="page-projects">
    ...
    <div id="wrapper">
        ...
        <!-- subheader -->
        <section id="subheader" data-bgimage="url(images/background/contact_us.jpg" class="style-2" data-stellar-background-ratio=".1">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                                ...
                                <div class="col-md-4">
                                    <div class="info-box padding20">
                                        ...
                                        <div class="info-box_text">
                                            ...
                                            <div class="info-box_subtite">Monday - Saturday: 08:00 - 18:00</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="info-box padding20">
                                        ...
                                        <div class="info-box_text">
                                            ...
                                            <div class="info-box_subtite">Nairobi, Kenya</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="info-box padding20">
                                        ...
                                        <div class="info-box_text">
                                            ...
                                            <div class="info-box_subtite">0714794301</div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <form name="contactForm" id='contact_form' method="post" action='email.php'>
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <p id='submit'>
                                        <input type='submit' id='send_message' value='Submit Form' class="btn btn-secondary">
                                    </p>
                    ...
                    <div id="sidebar" class="col-md-4">
                        ...
                        <div class="widget widget_text">
                            ...
                            <address>
                                ...
                                <span><strong><i class="fa fa-phone"></i></strong>0714794301</span>
                                <span><strong><i class="fa fa-envelope"></i></strong><a href="mailto:info@kingsmetal.co.ke">info@kingsmetal.co.ke</a></span>
                                <span><strong><i class="fa fa-globe"></i></strong><a href="#test">www.kingsmetal.co.ke/</a></span>
                                <span><strong><i class="icon_house_alt"></i></strong>Kawangware</span>
                                <span><strong><i class="icon_clock_alt"></i></strong>Monday - Saturday 08:00 - 18:00</span>
                            </address>
                        </div>
                    </div>
                </div>
        ...
        <footer>
            <div class="container pb40">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        &copy; Copyright 2019 - Kings Metal Works|<span class="id-color">Makovics IT Solutionists</span>
                    </div>
