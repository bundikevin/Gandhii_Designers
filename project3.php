...
<body>
    ...
    <div id="wrapper">
        ...
        <!-- subheader -->
        <section id="subheader" data-bgimage="url(images/background/subheader-8.jpg" class="style-2" data-stellar-background-ratio=".1">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                ...
                <div class="row">
                    <div id="sidebar" class="col-md-3 wow fadeInUp">
                        <ul id="services-list" class="s1">
                            ...
                            <li class="active"><a href="#">Snow Cleaning</a></li>
                    ...
                    <div class="col-md-9">
                        <div class="row">
                            <div class="col-md-6 wow fadeInUp" data-wow-delay=".3s">
								<img src="images/services/p3_a.jpg" class="img-rounded img-responsive mb30" alt="">
                            ...
                            <div class="col-md-6 pic-services wow fadeInUp" data-wow-delay=".6s">
								...
								<img src="images/services/p3_b.jpg" class="img-rounded img-responsive mt10" alt="">
                            </div>
                        </div>
                    </div>
